...
class MyApp(QtWidgets.QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.diccionario = {}
        self.diccionario[0] = ["Jorge", "ISC", ":/imagenes/uno"]
        self.diccionario[1] = ["Chris", "IC", ":/imagenes/dos"]
        self.diccionario[2] = ["Jeremias", "ISC", ":/imagenes/tres"]
        self.diccionario[3] = ["Karla", "II", ":/imagenes/cuatro"]
        self.diccionario[4] = ["Granda", "IM", ":/imagenes/cinco"]
        self.diccionario[5] = ["Villalobos", "IC", ":/imagenes/seis"]
